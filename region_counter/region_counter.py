...
path = r'c:\Users\91623\Downloads\run.mp4'
videocapture = cv2.VideoCapture(path)

frame_width, frame_height, fps = (int(videocapture.get(x)) for x in (cv2.CAP_PROP_FRAME_WIDTH, cv2.CAP_PROP_FRAME_HEIGHT, cv2.CAP_PROP_FPS))
video_writer = cv2.VideoWriter("object_counting_output.avi", cv2.VideoWriter_fourcc(*"mp4v"), fps, (frame_width, frame_height))
